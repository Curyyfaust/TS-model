# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 10:21:35 2024
...
class ProbAttention(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask=0, tau=None, delta=None):
        ...
        return context.contiguous().permute(0,2,1,3), attn
...
class AttentionLayer(nn.Module):
    def __init__(self, attention, d_model, n_heads=2, d_keys=None,
        ...
        self.inner_attention = attention #添加Attention layer
...
model=AttentionLayer(DSAttention(),8)
y=model(x,x,x)

y[0].shape-->torch.Size([32, 96, 8])
"""
